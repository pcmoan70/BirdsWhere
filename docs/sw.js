...
var NOTES = [
  "What's new:",
  "• Species list search: type in the “Filter species…” box (next to the layout dropdown) to narrow the list by name — reliable on phones and in the full-screen list, where the browser's own Ctrl-F can't scroll to matches.",
